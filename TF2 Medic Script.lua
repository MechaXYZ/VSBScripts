...
msh.MeshId = "rbxassetid://9085940296"
msh.TextureId = "rbxassetid://" ..sgtexture
msh.Scale = Vector3.new(1, 1, 1)/mult
local glass = Instance.new("SpawnLocation", sg)
glass.Name = "Glass"
glass.CanCollide = false
glass.Transparency = .5
glass.Enabled = false
glass.Size = Vector3.new(7.689, 7.378, 16.139)/mult
glass.Position = Vector3.new(9.685, -3.984, -36.79)/mult
local msh = Instance.new("SpecialMesh", glass)
msh.MeshId = "rbxassetid://9085246283"
msh.TextureId = "rbxassetid://9085957386"
msh.Scale = Vector3.new(1, 1, 1)/mult
...
fake4.Parent = bo
local fake45 = glass:Clone()
fake45.Parent = bo
fake45.Transparency = 1
...
fake45.Transparency = glass.Transparency
fake45.Transparency = glass.Transparency
